...
export declare type TNativeAudioWorkletNodeFakerFactory = (nativeAudioContext: TNativeAudioContext | TNativeOfflineAudioContext, processorDefinition: IAudioWorkletProcessorConstructor, options: {
