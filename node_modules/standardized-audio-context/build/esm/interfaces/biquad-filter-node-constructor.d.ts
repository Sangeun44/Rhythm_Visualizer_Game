...
export interface IBiquadFilterNodeConstructor {
    new (context: IAudioContext | IMinimalAudioContext | IMinimalOfflineAudioContext | IOfflineAudioContext, options?: Partial<IBiquadFilterOptions>): IBiquadFilterNode;
}
