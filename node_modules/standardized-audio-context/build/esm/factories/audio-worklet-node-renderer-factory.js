...
var processBuffer = function (proxy, renderedBuffer, offlineAudioContext, options, processorDefinition) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, getAudioWorkletProcessor(offlineAudioContext, proxy)];
            case 1:
                    ...
                    try {
                        var potentiallyEmptyInputs = inputs
                            ...
                            if (audioNodeConnections.inputs[index].size === 0) {
                                return input.map(function () { return new Float32Array(); });
                            }
                            return input;
                        });
            ...
            render: function (proxy, offlineAudioContext) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_j) {
                    switch (_j.label) {
                                    ...
                                    return tslib_1.__generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                ...
                                                return [4 /*yield*/, processBuffer(proxy, renderedBuffer, offlineAudioContext, options, processorDefinition)];
                                            case 1:
                        ...
                        case 2:
                            if (!!isOwnedByContext(nativeNode, offlineAudioContext)) return [3 /*break*/, 7];
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, renderAutomation(proxy.context, offlineAudioContext, audioParam, nativeNode.parameters.get(nm))];
                        case 4:
                            _j.sent();
                            _j.label = 5;
                        case 5:
                        ...
                        case 8:
                            ...
                            return [4 /*yield*/, connectAudioParam(proxy.context, offlineAudioContext, audioParam, nativeNode.parameters.get(nm))];
                        case 9:
                            _j.sent();
                            _j.label = 10;
                        case 10:
                            _f++;
                            return [3 /*break*/, 8];
                        case 11: return [4 /*yield*/, renderInputsOfAudioNode(proxy, offlineAudioContext, nativeNode)];
                        case 12:
                            _j.sent();
                            return [2 /*return*/, nativeNode];
                    }
