(function (global, factory) {
    ...
    var createAnalyserNodeConstructor = function createAnalyserNodeConstructor(createAnalyserNodeRenderer, createNativeAnalyserNode, isNativeOfflineAudioContext, noneAudioDestinationNodeConstructor) {
        return function (_noneAudioDestination) {
            ...
            function AnalyserNode(context) {
                ...
                var nativeNode = createNativeAnalyserNode(nativeContext, mergedOptions);
                var analyserNodeRenderer = isNativeOfflineAudioContext(nativeContext) ? createAnalyserNodeRenderer() : null;

                var _this = _possibleConstructorReturn(this, (AnalyserNode.__proto__ || Object.getPrototypeOf(AnalyserNode)).call(this, context, nativeNode, analyserNodeRenderer));
    ...
    var getNativeNode = function getNativeNode(audioNode) {
        var nativeNode = AUDIO_NODE_STORE.get(audioNode);
    ...
    var isOwnedByContext = function isOwnedByContext(nativeNode, nativeContext) {
        ...
        return nativeNode.context === nativeContext;
    };

    var getAudioGraph = function getAudioGraph(anyContext) {
    ...
    var renderInputsOfAudioNode = function renderInputsOfAudioNode(audioNode, offlineAudioContext, nativeAudioNode) {
        ...
        return Promise.all(audioNodeConnections.inputs.map(function (connections, input) {
            return Array.from(connections.values()).map(function (_ref) {
                ...
                return getAudioNodeRenderer(source).render(source, offlineAudioContext).then(function (node) {
    ...
    var createAnalyserNodeRendererFactory = function createAnalyserNodeRendererFactory(createNativeAnalyserNode) {
        return function () {
            var nativeNode = null;
            return {
                render: function render(proxy, offlineAudioContext) {
                            ...
                            while (1) {
                                switch (_context.prev = _context.next) {
                                    case 0:
                                        ...
                                        return _context.abrupt('return', nativeNode);
    ...
    var createAudioBufferSourceNodeConstructor = function createAudioBufferSourceNodeConstructor(createAudioBufferSourceNodeRenderer, createAudioParam, createInvalidStateError, createNativeAudioBufferSourceNode, isNativeOfflineAudioContext, noneAudioDestinationNodeConstructor) {
        return function (_noneAudioDestination) {
            ...
            function AudioBufferSourceNode(context) {
                ...
                var _this = _possibleConstructorReturn(this, (AudioBufferSourceNode.__proto__ || Object.getPrototypeOf(AudioBufferSourceNode)).call(this, context, nativeNode, audioBufferSourceNodeRenderer));
                                ...
                                switch (_context.prev = _context.next) {
                                    ...
                                    case 2:
                                        ...
                                        if (!isOwnedByContext(nativeNode, offlineAudioContext)) {
                                            ...
                                            if (start !== null) {
                                                (_nativeNode = nativeNode).start.apply(_nativeNode, _toConsumableArray(start));
                                            }
                                            if (stop !== null) {
    ...
    var createAudioDestinationNodeConstructor = function createAudioDestinationNodeConstructor(audioNodeConstructor, createAudioDestinationNodeRenderer, createIndexSizeError, createInvalidStateError, createNativeAudioDestinationNode, isNativeOfflineAudioContext) {
        return function (_audioNodeConstructor) {
            ...
            function AudioDestinationNode(context, channelCount) {
                ...
                var nativeContext = getNativeContext(context);
                var isOffline = isNativeOfflineAudioContext(nativeContext);
                var nativeNode = createNativeAudioDestinationNode(nativeContext, channelCount, isOffline);
                ...
                var _this = _possibleConstructorReturn(this, (AudioDestinationNode.__proto__ || Object.getPrototypeOf(AudioDestinationNode)).call(this, context, nativeNode, audioDestinationNodeRenderer));
    ...
    var getAudioParamConnections = function getAudioParamConnections(anyContext, audioParam) {
    ...
    var testAudioNodeDisconnectMethodSupport = function testAudioNodeDisconnectMethodSupport(audioContext) {
    ...
    var wrapAudioNodeDisconnectMethod = function wrapAudioNodeDisconnectMethod(audioNode) {
    ...
    var addAudioNode = function addAudioNode(context, audioNode, audioNoderRender, nativeNode) {
    ...
    var createAudioWorkletNodeConstructor = function createAudioWorkletNodeConstructor(createAudioParam, createAudioWorkletNodeRenderer, createNativeAudioWorkletNode, isNativeOfflineAudioContext, nativeAudioWorkletNodeConstructor, noneAudioDestinationNodeConstructor) {
        return function (_noneAudioDestination) {
            ...
            function AudioWorkletNode(context, name) {
                ...
                var nativeNode = createNativeAudioWorkletNode(nativeContext, nativeAudioWorkletNodeConstructor, name, processorDefinition, mergedOptions);
                var isOffline = isNativeOfflineAudioContext(nativeContext);
                var audioWorkletNodeRenderer = isOffline ? createAudioWorkletNodeRenderer(name, mergedOptions, processorDefinition) : null;

                var _this = _possibleConstructorReturn(this, (AudioWorkletNode.__proto__ || Object.getPrototypeOf(AudioWorkletNode)).call(this, context, nativeNode, audioWorkletNodeRenderer));

                var parameters = [];
                nativeNode.parameters.forEach(function (nativeAudioParam, nm) {
                ...
                _this._numberOfOutputs = options.numberOfOutputs === 0 ? 0 : _this._nativeNode.numberOfOutputs;
            ...
            _createClass(AudioWorkletNode, [{
                ...
                get: function get() {
                    return this._nativeNode.onprocessorerror;
                },
                set: function set(value) {
                    this._nativeNode.onprocessorerror = value;
                }
            }, {
                key: 'parameters',
                get: function get() {
                    if (this._parameters === null) {
                        return this._nativeNode.parameters;
                    }
    ...
    var renderInputsOfAudioParam = function renderInputsOfAudioParam(context, audioParam, offlineAudioContext, nativeAudioParam) {
        ...
        return Promise.all(Array.from(audioParamConnections.inputs).map(function (_ref) {
            ...
            return audioNodeRenderer.render(source, offlineAudioContext).then(function (node) {
    ...
    var connectAudioParam = function connectAudioParam(context, nativeOfflineAudioContext, audioParam) {
        var nativeAudioParam = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : AUDIO_PARAM_STORE.get(audioParam);
    ...
    var getAudioWorkletProcessor = function getAudioWorkletProcessor(offlineAudioContext, proxy) {
        var nodeToProcessorMap = NODE_TO_PROCESSOR_MAPS.get(offlineAudioContext);
        if (nodeToProcessorMap === undefined) {
            throw new Error('Missing the processor map for the given OfflineAudioContext.');
        }
        var nativeNode = getNativeNode(proxy);
        var audioWorkletProcessorPromise = nodeToProcessorMap.get(nativeNode);
    ...
    var getAudioParamRenderer = function getAudioParamRenderer(anyContext, audioParam) {
    ...
    var processBuffer = function processBuffer(proxy, renderedBuffer, offlineAudioContext, options, processorDefinition) {
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            processedBuffer = numberOfOutputChannels === 0 ? null : offlineAudioContext.createBuffer(numberOfOutputChannels, length, renderedBuffer.sampleRate);
                        ...
                        case 6:
                            ...
                            _context.next = 9;
                            return getAudioWorkletProcessor(offlineAudioContext, proxy);
                            ...
                            while (1) {
                                switch (_context4.prev = _context4.next) {
                                    case 0:
                                        ...
                                        return _context4.abrupt('return', nativeNode);
                                    ...
                                    case 8:
                                        ...
                                        Math.ceil(proxy.context.length / 128) * 128, offlineAudioContext.sampleRate);
                                        gainNodes = [];
                                                ...
                                                return _regeneratorRuntime.wrap(function _callee3$(_context3) {
                                                    while (1) {
                                                        switch (_context3.prev = _context3.next) {
                                                            case 0:
                                                                audioBufferSourceNode = createNativeAudioBufferSourceNode(offlineAudioContext);
                                                                numberOfOutputChannels = options.outputChannelCount.reduce(function (sum, value) {
                                                                    return sum + value;
                                                                }, 0);
                                                                outputChannelSplitterNode = createNativeChannelSplitterNode(offlineAudioContext, {
                                                                ...
                                                                _context3.next = 7;
                                                                return processBuffer(proxy, renderedBuffer, offlineAudioContext, options, processorDefinition);
                                                            ...
                                                            case 7:
                                                                ...
                                                                return _context3.abrupt('return', nativeNode);
                                    ...
                                    case 47:
                                        ...
                                        _context4.next = 51;
                                        return renderAutomation(proxy.context, offlineAudioContext, audioParam, nativeNode.parameters.get(nm));
                                    ...
                                    case 75:
                                        ...
                                        _context4.next = 79;
                                        return connectAudioParam(proxy.context, offlineAudioContext, audioParam, nativeNode.parameters.get(nm));
    ...
    var testPromiseSupport = function testPromiseSupport(audioContext) {
    ...
    var isSupportingPromises = function isSupportingPromises(context) {
        return cacheTestResult(testPromiseSupport, function () {
            return testPromiseSupport(context);
        });
    };
    var decodeAudioData = function decodeAudioData(audioContext, audioData) {
        ...
        if (isSupportingPromises(audioContext)) {
            var promise = audioContext.decodeAudioData(audioData).catch(function (err) {
    ...
    var createBaseAudioContextConstructor = function createBaseAudioContextConstructor(analyserNodeConstructor, audioBufferConstructor, audioBufferSourceNodeConstructor, biquadFilterNodeConstructor, channelMergerNodeConstructor, channelSplitterNodeConstructor, constantSourceNodeConstructor, gainNodeConstructor, iIRFilterNodeConstructor, minimalBaseAudioContextConstructor, oscillatorNodeConstructor) {
        return function (_minimalBaseAudioCont) {
            ...
            function BaseAudioContext(context, numberOfChannels) {
                _classCallCheck(this, BaseAudioContext);

                var _this = _possibleConstructorReturn(this, (BaseAudioContext.__proto__ || Object.getPrototypeOf(BaseAudioContext)).call(this, context, numberOfChannels));
            ...
            _createClass(BaseAudioContext, [{
                ...
                value: function decodeAudioData$$1(audioData, successCallback, errorCallback) {
                    return decodeAudioData(this._context, audioData).then(function (audioBuffer) {
    ...
    var createBiquadFilterNodeConstructor = function createBiquadFilterNodeConstructor(createAudioParam, createBiquadFilterNodeRenderer, createInvalidAccessError, createNativeBiquadFilterNode, isNativeOfflineAudioContext, noneAudioDestinationNodeConstructor) {
        return function (_noneAudioDestination) {
            ...
            function BiquadFilterNode(context) {
                ...
                var nativeNode = createNativeBiquadFilterNode(nativeContext, mergedOptions);
                var isOffline = isNativeOfflineAudioContext(nativeContext);
                ...
                var _this = _possibleConstructorReturn(this, (BiquadFilterNode.__proto__ || Object.getPrototypeOf(BiquadFilterNode)).call(this, context, nativeNode, biquadFilterNodeRenderer));

                _this._Q = createAudioParam(context, isOffline, nativeNode.Q, 3.4028234663852886e38, -3.4028234663852886e38);
                ...
                _this._frequency = createAudioParam(context, isOffline, nativeNode.frequency, 3.4028234663852886e38, -3.4028234663852886e38);
                // Bug #79: Edge, Firefox & Safari do not export the correct values for maxValue and minValue.
                _this._gain = createAudioParam(context, isOffline, nativeNode.gain, 3.4028234663852886e38, -3.4028234663852886e38);
                _this._nativeNode = nativeNode;
                return _this;
            }
                            ...
                            while (1) {
                                switch (_context.prev = _context.next) {
                                    ...
                                    case 2:
                                        ...
                                        _context.next = 8;
                                        return renderAutomation(proxy.context, offlineAudioContext, proxy.Q, nativeNode.Q);

                                    case 8:
                                        _context.next = 10;
                                        return renderAutomation(proxy.context, offlineAudioContext, proxy.detune, nativeNode.detune);

                                    case 10:
                                        _context.next = 12;
                                        return renderAutomation(proxy.context, offlineAudioContext, proxy.frequency, nativeNode.frequency);

                                    case 12:
                                        _context.next = 14;
                                        return renderAutomation(proxy.context, offlineAudioContext, proxy.gain, nativeNode.gain);
                                    ...
                                    case 16:
                                        _context.next = 18;
                                        return connectAudioParam(proxy.context, offlineAudioContext, proxy.Q);

                                    case 18:
                                        _context.next = 20;
                                        return connectAudioParam(proxy.context, offlineAudioContext, proxy.detune);

                                    case 20:
                                        _context.next = 22;
                                        return connectAudioParam(proxy.context, offlineAudioContext, proxy.frequency);

                                    case 22:
                                        _context.next = 24;
                                        return connectAudioParam(proxy.context, offlineAudioContext, proxy.gain);
    ...
    var createChannelMergerNodeConstructor = function createChannelMergerNodeConstructor(createChannelMergerNodeRenderer, createNativeChannelMergerNode, isNativeOfflineAudioContext, noneAudioDestinationNodeConstructor) {
        return function (_noneAudioDestination) {
            ...
            function ChannelMergerNode(context) {
                ...
                var nativeNode = createNativeChannelMergerNode(nativeContext, mergedOptions);
                var channelMergerNodeRenderer = isNativeOfflineAudioContext(nativeContext) ? createChannelMergerNodeRenderer() : null;
                return _possibleConstructorReturn(this, (ChannelMergerNode.__proto__ || Object.getPrototypeOf(ChannelMergerNode)).call(this, context, nativeNode, channelMergerNodeRenderer));
            }
    ...
    var createChannelSplitterNodeConstructor = function createChannelSplitterNodeConstructor(createChannelSplitterNodeRenderer, createNativeChannelSplitterNode, isNativeOfflineAudioContext, noneAudioDestinationNodeConstructor) {
        return function (_noneAudioDestination) {
            ...
            function ChannelSplitterNode(context) {
                ...
                var nativeNode = createNativeChannelSplitterNode(nativeContext, mergedOptions);
                var channelSplitterNodeRenderer = isNativeOfflineAudioContext(nativeContext) ? createChannelSplitterNodeRenderer() : null;
                return _possibleConstructorReturn(this, (ChannelSplitterNode.__proto__ || Object.getPrototypeOf(ChannelSplitterNode)).call(this, context, nativeNode, channelSplitterNodeRenderer));
            }
    ...
    var createConstantSourceNodeConstructor = function createConstantSourceNodeConstructor(createAudioParam, createConstantSourceNodeRendererFactory, createNativeConstantSourceNode, isNativeOfflineAudioContext, noneAudioDestinationNodeConstructor) {
        return function (_noneAudioDestination) {
            ...
            function ConstantSourceNode(context) {
                ...
                var _this = _possibleConstructorReturn(this, (ConstantSourceNode.__proto__ || Object.getPrototypeOf(ConstantSourceNode)).call(this, context, nativeNode, constantSourceNodeRenderer));
                            ...
                            while (1) {
                                switch (_context.prev = _context.next) {
                                    ...
                                    case 2:
                                        ...
                                        _context.next = 10;
                                        return renderAutomation(proxy.context, offlineAudioContext, proxy.offset, nativeNode.offset);
                                    ...
                                    case 12:
                                        _context.next = 14;
                                        return connectAudioParam(proxy.context, offlineAudioContext, proxy.offset);
    ...
    var createGainNodeConstructor = function createGainNodeConstructor(createAudioParam, createGainNodeRenderer, createNativeGainNode, isNativeOfflineAudioContext, noneAudioDestinationNodeConstructor) {
        return function (_noneAudioDestination) {
            ...
            function GainNode(context) {
                ...
                var nativeNode = createNativeGainNode(nativeContext, mergedOptions);
                var isOffline = isNativeOfflineAudioContext(nativeContext);
                ...
                var _this = _possibleConstructorReturn(this, (GainNode.__proto__ || Object.getPrototypeOf(GainNode)).call(this, context, nativeNode, gainNodeRenderer));
    ...
    var wrapIIRFilterNodeGetFrequencyResponseMethod = function wrapIIRFilterNodeGetFrequencyResponseMethod(iIRFilterNode) {
    ...
    var createIIRFilterNodeConstructor = function createIIRFilterNodeConstructor(createNativeIIRFilterNode, createIIRFilterNodeRenderer, isNativeOfflineAudioContext, noneAudioDestinationNodeConstructor) {
        return function (_noneAudioDestination) {
            ...
            function IIRFilterNode(context, options) {
                ...
                var _this = _possibleConstructorReturn(this, (IIRFilterNode.__proto__ || Object.getPrototypeOf(IIRFilterNode)).call(this, context, nativeNode, iirFilterNodeRenderer));
    ...
    var filterFullBuffer = function filterFullBuffer(renderedBuffer, offlineAudioContext, feedback, feedforward) {
                            ...
                            while (1) {
                                switch (_context.prev = _context.next) {
                                    ...
                                    case 8:
                                        ...
                                        return _context.abrupt('return', renderInputsOfAudioNode(proxy, offlineAudioContext, nativeNode).then(function () {
                                            return nativeNode;
                                        }));
    ...
    var createMediaElementAudioSourceNodeConstructor = function createMediaElementAudioSourceNodeConstructor(noneAudioDestinationNodeConstructor) {
        return function (_noneAudioDestination) {
            ...
            function MediaElementAudioSourceNode(context, options) {
                ...
                var nativeNode = nativeContext.createMediaElementSource(mergedOptions.mediaElement);

                // Bug #63: Edge & Firefox do not expose the mediaElement yet.
                var _this = _possibleConstructorReturn(this, (MediaElementAudioSourceNode.__proto__ || Object.getPrototypeOf(MediaElementAudioSourceNode)).call(this, context, nativeNode, null));
    ...
    var createMediaStreamAudioSourceNodeConstructor = function createMediaStreamAudioSourceNodeConstructor(noneAudioDestinationNodeConstructor) {
        return function (_noneAudioDestination) {
            ...
            function MediaStreamAudioSourceNode(context, options) {
                ...
                var nativeNode = nativeContext.createMediaStreamSource(mergedOptions.mediaStream);

                // Bug #63: Edge & Firefox do not expose the mediaStream yet.
                var _this = _possibleConstructorReturn(this, (MediaStreamAudioSourceNode.__proto__ || Object.getPrototypeOf(MediaStreamAudioSourceNode)).call(this, context, nativeNode, null));
    ...
    var createMinimalBaseAudioContextConstructor = function createMinimalBaseAudioContextConstructor(audioDestinationNodeConstructor) {
        return function (_EventTarget) {
            ...
            function MinimalBaseAudioContext(context, numberOfChannels) {
                ...
                CONTEXT_STORE.set(_this, context);
                _this._context = context;
            ...
            _createClass(MinimalBaseAudioContext, [{
                ...
                key: 'onstatechange',
                get: function get() {
                    return this._context.onstatechange;
                },
                set: function set(value) {
                    this._context.onstatechange = value;
                }
            }, {
                key: 'sampleRate',
                get: function get() {
    ...
    var createMinimalOfflineAudioContextConstructor = function createMinimalOfflineAudioContextConstructor(minimalBaseAudioContextConstructor, nativeOfflineAudioContextConstructor, _startRendering) {
        return function (_minimalBaseAudioCont) {
    ...
    var wrapAnalyserNodeGetFloatTimeDomainDataMethod = function wrapAnalyserNodeGetFloatTimeDomainDataMethod(analyserNode) {
    ...
    var createNativeAnalyserNode = function createNativeAnalyserNode(nativeContext, options) {
        var nativeNode = nativeContext.createAnalyser();
    ...
    var testAudioBufferSourceNodeStartMethodConsecutiveCallsSupport = function testAudioBufferSourceNodeStartMethodConsecutiveCallsSupport(audioContext) {
    ...
    var testAudioScheduledSourceNodeStartMethodNegativeParametersSupport = function testAudioScheduledSourceNodeStartMethodNegativeParametersSupport(audioContext) {
        var audioBuffer = audioContext.createBufferSource();
        try {
            audioBuffer.start(-1);
        } catch (err) {
    ...
    var testAudioScheduledSourceNodeStopMethodConsecutiveCallsSupport = function testAudioScheduledSourceNodeStopMethodConsecutiveCallsSupport(audioContext) {
    ...
    var testAudioScheduledSourceNodeStopMethodNegativeParametersSupport = function testAudioScheduledSourceNodeStopMethodNegativeParametersSupport(audioContext) {
        var audioBuffer = audioContext.createBufferSource();
        try {
            audioBuffer.stop(-1);
        } catch (err) {
    ...
    var wrapAudioBufferSourceNodeStartMethodConsecutiveCalls = function wrapAudioBufferSourceNodeStartMethodConsecutiveCalls(audioBufferSourceNode) {
        audioBufferSourceNode.start = function (start) {
    ...
    var wrapAudioScheduledSourceNodeStartMethodNegativeParameters = function wrapAudioScheduledSourceNodeStartMethodNegativeParameters(audioScheduledSourceNode) {
        audioScheduledSourceNode.start = function (start) {
            return function () {
                var when = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
                var offset = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
                var duration = arguments[2];
    ...
    var wrapAudioScheduledSourceNodeStopMethodConsecutiveCalls = function wrapAudioScheduledSourceNodeStopMethodConsecutiveCalls(audioScheduledSourceNode, audioContext) {
        ...
        audioScheduledSourceNode.connect = function (destination) {
            var output = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
            var input = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
    ...
    var wrapAudioScheduledSourceNodeStopMethodNegativeParameters = function wrapAudioScheduledSourceNodeStopMethodNegativeParameters(audioScheduledSourceNode) {
        audioScheduledSourceNode.stop = function (stop) {
            return function () {
                var when = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    ...
    var createNativeAudioDestinationNode = function createNativeAudioDestinationNode(nativeContext, channelCount, isNodeOfNativeOfflineAudioContext) {
        var nativeNode = nativeContext.destination;
    ...
    var createAudioWorkletProcessor = function createAudioWorkletProcessor(nativeAudioContext, nativeAudioWorkletNode, processorDefinition, audioWorkletNodeOptions) {
        var nodeToProcessorMap = NODE_TO_PROCESSOR_MAPS.get(nativeAudioContext);
        if (nodeToProcessorMap === undefined) {
    ...
    var createNativeBiquadFilterNode = function createNativeBiquadFilterNode(nativeContext, options) {
        var nativeNode = nativeContext.createBiquadFilter();
        assignNativeAudioNodeOptions(nativeNode, options);
    ...
    var wrapChannelMergerNode = function wrapChannelMergerNode(audioContext, channelMergerNode) {
        var audioBufferSourceNode = audioContext.createBufferSource();
    ...
    var createNativeChannelMergerNode = function createNativeChannelMergerNode(nativeContext) {
        ...
        if (nativeNode.channelCount !== 1 && nativeNode.channelCountMode !== 'explicit') {
    ...
    var createNativeChannelSplitterNode = function createNativeChannelSplitterNode(nativeContext) {
        var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

        var nativeNode = nativeContext.createChannelSplitter(options.numberOfOutputs === undefined ? 6 : options.numberOfOutputs);
        assignNativeAudioNodeOptions(nativeNode, options);
    ...
    var testConstantSourceNodeAccurateSchedulingSupport = function testConstantSourceNodeAccurateSchedulingSupport(audioContext) {
    ...
    var wrapConstantSourceNodeAccurateScheduling = function wrapConstantSourceNodeAccurateScheduling(constantSourceNode, audioContext) {
        var gainNode = audioContext.createGain();
    ...
    var createNativeConstantSourceNodeFactory = function createNativeConstantSourceNodeFactory(createNativeConstantSourceNodeFaker) {
        return function (nativeContext, options) {
            ...
            var nativeNode = nativeContext.createConstantSource();
            assignNativeAudioNodeOptions(nativeNode, options);
    ...
    var createNativeGainNode = function createNativeGainNode(nativeContext, options) {
        var nativeNode = nativeContext.createGain();
        assignNativeAudioNodeOptions(nativeNode, options);
        if (options.gain !== nativeNode.gain.value) {
            nativeNode.gain.value = options.gain;
        }
    ...
    var createNativeIIRFilterNodeFactory = function createNativeIIRFilterNodeFactory(createNativeIIRFilterNodeFaker) {
        return function (nativeContext, options) {
            ...
            var nativeNode = nativeContext.createIIRFilter(options.feedforward, options.feedback);
            assignNativeAudioNodeOptions(nativeNode, options);
            return nativeNode;
        };
    };
    ...
    var createNativeOscillatorNode = function createNativeOscillatorNode(nativeContext, options) {
        var nativeNode = nativeContext.createOscillator();
        assignNativeAudioNodeOptions(nativeNode, options);
        if (options.detune !== nativeNode.detune.value) {
            nativeNode.detune.value = options.detune;
        }
    ...
    var createNoneAudioDestinationNodeConstructor = function createNoneAudioDestinationNodeConstructor(audioNodeConstructor, createInvalidStateError) {
        return function (_audioNodeConstructor) {
            ...
            function NoneAudioDestinationNode(context, nativeNode, audioNodeRenderer) {
                ...
                var _this = _possibleConstructorReturn(this, (NoneAudioDestinationNode.__proto__ || Object.getPrototypeOf(NoneAudioDestinationNode)).call(this, context, nativeNode, audioNodeRenderer));
    ...
    var createOfflineAudioContextConstructor = function createOfflineAudioContextConstructor(baseAudioContextConstructor, nativeOfflineAudioContextConstructor, _startRendering) {
        return function (_baseAudioContextCons) {
    ...
    var createOscillatorNodeConstructor = function createOscillatorNodeConstructor(createAudioParam, createInvalidStateError, createNativeOscillatorNode, createOscillatorNodeRenderer, isNativeOfflineAudioContext, noneAudioDestinationNodeConstructor) {
        return function (_noneAudioDestination) {
            ...
            function OscillatorNode(context) {
                ...
                var _this = _possibleConstructorReturn(this, (OscillatorNode.__proto__ || Object.getPrototypeOf(OscillatorNode)).call(this, context, nativeNode, oscillatorNodeRenderer));
    ...
    var isSupportingPromises$1 = function isSupportingPromises(context) {
        return cacheTestResult(testPromiseSupport, function () {
            return testPromiseSupport(context);
        });
    };
    ...
    var minimalOfflineAudioContextConstructor = createMinimalOfflineAudioContextConstructor(minimalBaseAudioContextConstructor, nativeOfflineAudioContextConstructor, startRendering);
    var offlineAudioContextConstructor = createOfflineAudioContextConstructor(baseAudioContextConstructor, nativeOfflineAudioContextConstructor, startRendering);
